...
- Web scraping for TikTok, SUNAT & OSIPTEL — **95% success rate** using Selenium, Playwright & Scrapy with proxy rotation
- Integrated **Fal.ai API & API Mart** for AI image generation, processing 1,000+ monthly requests
- Built a full web-based video editor with JavaScript, React & FFmpeg
- Automated workflows with **Claude Code + MCP + AI Agents**, reducing execution time by **70%**
...
- Supported courses in programming, algorithms & data structures
- Designed lab guides and practical exercises in **C++, Python & Java**
- Technical mentoring and final project evaluations

**📚 Programming Instructor — Data Structures**
...
<img src="https://img.shields.io/badge/Proxy_Rotation-FF6B35?style=for-the-badge&logo=cloudflare&logoColor=white"/>
</p>
...
<img src="https://img.shields.io/badge/MCP-4B0082?style=for-the-badge&logo=anthropic&logoColor=white"/>
...
<img src="https://img.shields.io/badge/Fal.ai_API-000000?style=for-the-badge&logo=ai&logoColor=white"/>
</p>
...
<img src="https://img.shields.io/badge/Valgrind-5C2D91?style=for-the-badge&logo=linux&logoColor=white"/>
</p>
...
Robust data extraction pipeline with automatic residential proxy rotation, dynamic headers, and anti-detection logic. Handles CAPTCHAs and rate limiting — **95% success rate.**
...
| | Certification / Degree | Institution | Year |
|:---:|---|---|:---:|
| ☁️ | **AWS Academy Cloud Foundations** | Amazon Web Services | 2025 |
| 🎓 | **B.Sc. Computer Science** *(Ongoing — 9th semester)* | Universidad Católica San Pablo · Arequipa | 2020 – 2025 |
| 📚 | **Computer Science** *(4 semesters completed)* | UTEC · Lima | 2017 – 2018 |
...
![English](https://img.shields.io/badge/English-B1--B2%20%7C%20Advanced%20Technical%20Reading-blue?style=for-the-badge)

</div>

<br/>

> **Soft Skills:** Teamwork · Leadership · Effective Communication · Proactivity · Resilience · Responsibility · Adaptability · Critical Thinking · Problem Solving · Time Management · Mentoring · Teaching
...
![Footer](https://img.shields.io/badge/Thanks%20for%20visiting!-1793D1?style=for-the-badge&logo=arch-linux&logoColor=white)
![Arch](https://img.shields.io/badge/I%20use%20Arch%20btw-1793D1?style=for-the-badge&logo=arch-linux&logoColor=white)
